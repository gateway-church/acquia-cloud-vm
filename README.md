...
## Usage
  ...
  3. Copy `example.config.yml` to `config.yml` (your local `config.yml` will be ignored by Git and you can modify it to suit your needs).
  4. (From the same directory as this README file) run `$ vagrant up`
